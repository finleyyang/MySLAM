...
TEST(MyslamTest, ORBextractor) {
	...
	image = cv::imread("/home/finley/CODE/MySLAM/data/image_01/data/0000000000.png", 0);
	imageright = cv::imread("/home/finley/CODE/MySLAM/data/image_00/data/0000000000.png", 0);
...
int main(int argc, char* argv[])
{
	...
	::testing::FLAGS_gtest_filter ="MyslamTest.ORBextractor";
